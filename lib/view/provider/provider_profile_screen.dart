...
class ProviderProfileScreen extends StatelessWidget {
  ...
  // ---------------------------------------------------------------------------
  final String _name = 'Thandi Ndlovu';
  final int _memberSinceYear = 2022;
  final double _avgRating = 4.8;
  final int _jobsCompleted = 120;
  final String _primaryCategory = 'Plumber';
  final List<String> _skills = const ['Leak repair', 'Pipe fitting', 'Drain cleaning', 'Water heaters', 'Emergency callout'];
  final String _serviceRadius = '15 km around Pretoria';
  final String _availability = 'Mon–Fri • 09:00–17:00';
  final String _pricing = 'R250/hr';
  final String _experience = '3 years professional experience';
  final String _approvalStatus = 'Approved'; // or Pending
  final double _walletBalance = 1250.00;
  final String _payoutAccountMasked = 'Bank • **** 1234';
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // Avatar centered to mirror client profile consistency
                      // Match client avatar radius to keep consistency
                      CircleAvatar(
                        radius: 80,
                        backgroundColor: cs.primaryContainer,
                        child: Icon(Icons.person, color: cs.onPrimaryContainer, size: 64),
                      ),

                      const SizedBox(height: 12),

                      // Name with verification badge (if approved)
                      Row(
                        ...
                        children: [
                          ...
                          if (_approvalStatus == 'Approved') Icon(Icons.verified, size: 18, color: cs.primary),
                        ],
                      ),
              ...
              _SectionCard(children: [
                ...
                ListTile(
                  ...
                  trailing: _StatusPill(label: _approvalStatus == 'Approved' ? 'Verified' : 'Verify', positive: _approvalStatus == 'Approved'),
                  onTap: () async {
              ...
              _SectionCard(children: [
                ...
                ListTile(
                  ...
                  title: const Text('Switch Dashboard (Client View)'),
                  trailing: const Icon(Icons.chevron_right),
                  onTap: () => Navigator.of(context).pushNamed('/choose-dashboard'),
                ),
                Divider(height: 1, color: cs.outlineVariant),
                ListTile(
